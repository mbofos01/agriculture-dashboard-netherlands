...
('Potential_evapotranspiration', 'The potential evapotranspiration (PET) (mm/day)'),
('Precipitation_rate', 'The rate of precipitation (mm/month)'),
('Minimum_2m_temperature', 'The minimum temperature at 2 meters above the ground (degrees Celsius)'),
('Mean_2m_temperature', 'The mean temperature at 2 meters above the ground (degrees Celsius)'),
('Maximum_2m_temperature', 'The maximum temperature at 2 meters above the ground (degrees Celsius)'),
('Vapour_pressure', 'The pressure of water vapor in the atmosphere (hPa)'),
('Frost_days', 'The number of frost days'),
('Wet_days', 'The number of wet days'),

('Cloud cover', 'The amount of cloud cover (%)'),
('potential evapo-transpiration', 'The potential evapotranspiration (PET) (mm/day)'),
('Precipitation rate', 'The rate of precipitation ((mm/month))'),
('Minimum 2m temperature', 'The minimum temperature at 2 meters above the ground (degrees Celsius)'),
('Mean 2m temperature', 'The mean temperature at 2 meters above the ground (degrees Celsius)'),
('Maximum 2m temperature', 'The maximum temperature at 2 meters above the ground (degrees Celsius)'),
('Vapour pressure', 'The pressure of water vapor in the atmosphere (hPa)'),
